...
grant all on seqTypeHabitation to agence_frontoffice_service;
...
INSERT INTO habitation VALUES(nextVal('seqHabitation'),1,5,2,'10TH FLOOR',75000,'Appartement avec piscine,garage et 5 chambres confortables');
...
select typeHabitation.nom,nbrChambre,quartier.nom,descript,adresse from habitationNonSupprime 
...
select typeHabitation.nom as typeHabitation,nbrChambre,quartier.nom as nomQuartier,descript,adresse from habitationNonSupprime 
        join quartier on habitationNonSupprime.idQuartier=quartier.idQuartier 
        join typeHabitation on typeHabitation.idtype=habitationNonSupprime.idType 
...
select typeHabitation.nom as type_habnom,nbrChambre,quartier.nom as quart_nom,descript,adresse from habitationNonSupprime 
        join quartier on habitationNonSupprime.idQuartier=quartier.idQuartier 
        join typeHabitation on typeHabitation.idtype=habitationNonSupprime.idType 
