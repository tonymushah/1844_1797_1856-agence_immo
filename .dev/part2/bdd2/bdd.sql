...
/*CREATE TABLE habitation   
    ...
    adresse VARCHAR(20),
    idLoyer int CONSTRAINT FK_idHabitation REFERENCES historiqueLoyer,
...
INSERT INTO habitation VALUES(nextVal('seqHabitationNv'),1,5,2,'10TH FLOOR',75000,'Appartement avec pismcine,garage et 5 chambres confortables');
...
INSERT INTO habitation VALUES(nextVal('seqHabitationNv'),5,4,4,'8THFLOOR',70000,'Maison avec des chambres confortables');
INSERT INTO habitation VALUES(nextVal('seqHabitationNv'),5,4,5,'8THFLOOR',50000,'Maison avec des chambres confortables');
INSERT INTO habitation VALUES(nextVal('seqHabitationNv'),5,4,1,'8THFLOOR',100000,'Maison avec des chambres confortables');
INSERT INTO habitation VALUES(nextVal('seqHabitationNv'),1,4,5,'12THFLOOR',90000,'Maison avec des chambres confortables');
INSERT INTO habitation VALUES(nextVal('seqHabitationNv'),1,3,5,'12THFLOOR',80000,'Maison avec des chambres confortables');
INSERT INTO habitation VALUES(nextVal('seqHabitationNv'),1,2,5,'12THFLOOR',60000,'Maison avec des chambres confortables');
INSERT INTO habitation VALUES(nextVal('seqHabitationNv'),1,1,1,'10THFLOOR',40000,'Maison avec des chambres confortables');
INSERT INTO habitation VALUES(nextVal('seqHabitationNv'),1,1,2,'10THFLOOR',50000,'Maison avec des chambres confortables');
INSERT INTO habitation VALUES(nextVal('seqHabitationNv'),1,1,3,'10THFLOOR',60000,'Maison avec des chambres confortables');
INSERT INTO habitation VALUES(nextVal('seqHabitationNv'),1,1,4,'10THFLOOR',90000,'Maison avec des chambres confortables');
INSERT INTO habitation VALUES(nextVal('seqHabitationNv'),2,1,1,'09THFLOOR',50000,'Maison avec des chambres confortables');
INSERT INTO habitation VALUES(nextVal('seqHabitationNv'),2,1,2,'09THFLOOR',60000,'Maison avec des chambres confortables');
INSERT INTO habitation VALUES(nextVal('seqHabitationNv'),2,1,3,'09THFLOOR',70000,'Maison avec des chambres confortables');
INSERT INTO habitation VALUES(nextVal('seqHabitationNv'),2,1,4,'09THFLOOR',80000,'Maison avec des chambres confortables');
INSERT INTO habitation VALUES(nextVal('seqHabitationNv'),2,2,5,'09THFLOOR',50000,'Maison avec des chambres confortables');
...
--donné historiqueLoyer vaovao
INSERT INTO historiqueLoyer VALUES(nextVal('seqHistoriqueLoyer'),1,'2022-01-05',50000);
INSERT INTO historiqueLoyer VALUES(nextVal('seqHistoriqueLoyer'),2,'2022-01-05',60000);
INSERT INTO historiqueLoyer VALUES(nextVal('seqHistoriqueLoyer'),3,'2022-01-05',80000);
INSERT INTO historiqueLoyer VALUES(nextVal('seqHistoriqueLoyer'),4,'2022-01-05',100000);
INSERT INTO historiqueLoyer VALUES(nextVal('seqHistoriqueLoyer'),5,'2022-01-05',90000);
INSERT INTO historiqueLoyer VALUES(nextVal('seqHistoriqueLoyer'),6,'2022-01-05',110000);
INSERT INTO historiqueLoyer VALUES(nextVal('seqHistoriqueLoyer'),7,'2022-01-05',70000);
